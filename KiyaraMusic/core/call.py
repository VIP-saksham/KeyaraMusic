...
import config
from KiyaraMusic import LOGGER, YouTube, app
...
from KiyaraMusic.utils.formatters import check_duration, seconds_to_min, speed_converter
from KiyaraMusic.utils.inline.play import stream_markup
...
class Call(PyTgCalls):
    ...
    async def _play_on_assistant(self, client, chat_id, stream):
        try:
            await client.play(
                chat_id=chat_id,
                stream=stream,
