...
from KiyaraMusic.utils.database import get_lang
from KiyaraMusic.utils.decorators.language import LanguageStart, languageCB
from KiyaraMusic.utils.inline.help import (
    help_back_markup,
    private_help_panel,
    help_pannel_page1,
    help_pannel_page2,
...
async def helper_private(
    ...
    if is_callback:
        ...
        from KiyaraMusic.utils.inline.help import help_pannel_page1
...
async def help_com_group(client, message: Message, _):
    from KiyaraMusic.utils.inline.help import private_help_panel
...
async def helper_cb(client, CallbackQuery, _):
    ...
    def get_keyboard_for(cb):
        ...
        page2 = ["hb11", "hb12", "hb13", "hb14", "hb15", "hb16", "hb17", "hb18", "hb19", "hb20"]
        page3 = ["hb21", "hb22", "hb23", "hb24", "hb25", "hb26", "hb27", "hb28", "hb29", "hb30"]
        page4 = ["hb31", "hb32", "hb33", "hb34", "hb35", "hb36", "hb37", "hb38", "hb39"]
