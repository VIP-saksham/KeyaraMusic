...
from KiyaraMusic import LOGGER
from pyrogram.types import Message
from KiyaraMusic.misc import SUDOERS
from KiyaraMusic import app
from KiyaraMusic.utils.database import *
from KiyaraMusic.utils.database import db

try:
    wlcm = db.welcome
except:
    from KiyaraMusic.utils.database import welcome as wlcm
...
def welcomepic(pic, user, chat, id, uname):
    background = Image.open("KiyaraMusic/assets/welcome.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp)
    pfp = pfp.resize((450, 450)) 
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('KiyaraMusic/assets/font.ttf', size=45)
    font2 = ImageFont.truetype('KiyaraMusic/assets/font.ttf', size=90)
...
async def greet_group(_, member: ChatMemberUpdated):
    ...
    try:
        ...
        pic = "KiyaraMusic/assets/upic.png"
