...
from KeyaraMusic.misc import SUDOERS, db
from KeyaraMusic.utils.database import (
    get_active_chats,
    get_lang,
    get_upvote_count,
    is_active_chat,
...
from KeyaraMusic.utils.formatters import seconds_to_min
from KeyaraMusic.utils.inline import close_markup, stream_markup, stream_markup_timer
from KeyaraMusic.utils.inline.help import help_pannel_page1, help_pannel_page2, help_pannel_page3, help_pannel_page4
from KeyaraMusic.utils.stream.autoclear import auto_clean
from KeyaraMusic.utils.thumbnails import gen_thumb
from config import (
    BANNED_USERS,
    SOUNCLOUD_IMG_URL,
    STREAM_IMG_URL,
...
async def fork_repo_callback(client, query):
    await query.message.edit_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🚀 Fᴏʀᴋ Rᴇᴘᴏ", url="https://github.com/NoxxOP/KeyaraMusic/fork"),
                    InlineKeyboardButton("⚡ Hᴇʀᴏᴋᴜ Dᴇᴘʟᴏʏ", url="https://dashboard.heroku.com/new?template=https://github.com/NoxxOP/KeyaraMusic")
                ],
                [
...
from KeyaraMusic.utils.inline.start import about_panel
from strings import get_string
...
from pyrogram import Client, filters
from pyrogram.types import InlineKeyboardMarkup
from KeyaraMusic.utils.inline.start import owner_panel  # Import owner_panel function
from strings import get_string
from config import BANNED_USERS
...
from KeyaraMusic import app
from KeyaraMusic.core.call import Nand
from KeyaraMusic.utils import bot_sys_stats
