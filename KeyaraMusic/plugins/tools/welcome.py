...
# from KeyaraMusic import LOGGER
# from pyrogram.types import Message
# from KeyaraMusic.misc import SUDOERS
# from KeyaraMusic import app
# from KeyaraMusic.utils.database import *
# from KeyaraMusic.utils.database import db

# try:
#     wlcm = db.welcome
# except:
#     from KeyaraMusic.utils.database import welcome as wlcm
...
#     background = Image.open("KeyaraMusic/assets/welcome.png")
#     pfp = Image.open(pic).convert("RGBA")
#     pfp = circle(pfp)
#     pfp = pfp.resize((450, 450)) 
#     draw = ImageDraw.Draw(background)
#     font = ImageFont.truetype('KeyaraMusic/assets/font.ttf', size=45)
#     font2 = ImageFont.truetype('KeyaraMusic/assets/font.ttf', size=90)
...
#         pic = "KeyaraMusic/assets/upic.png"
