...
def _background(art, rng, accent):
    ...
    # neon glow blobs — left accent, right cool blue (reference image vibe)
    for (gx, gy), color, rad, alpha in [
        ((rng.randint(90, 260), rng.randint(430, 640)), (*accent, 80), rng.randint(240, 320), None),
        ((rng.randint(1050, 1230), rng.randint(80, 280)), (80, 120, 255, 70), rng.randint(260, 340), None),
        ((rng.randint(400, 900), rng.randint(600, 740)), (*accent, 45), rng.randint(200, 260), None),
    ]:
