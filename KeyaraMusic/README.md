...
The main Python package for Keyara Music. It boots all clients, loads plugins,
and starts the music streaming engine.
...
| `__main__.py` | The runtime entry point — `python -m KeyaraMusic` |
